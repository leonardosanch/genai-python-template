...
Provide 3-5 key facts or points."""
            ...
            return {"research_output": output, "error": None}
...
Create a clear outline with main sections and sub-points."""
            ...
            return {"outline_output": output, "error": None}

        except Exception as e:
            return {"error": f"Outline failed: {str(e)}"}
...
Write clear, concise content for each section."""
            ...
            return {"draft_output": output, "error": None}
...
Improve clarity, fix errors, and polish the content."""
            ...
            return {"final_output": output, "error": None}
